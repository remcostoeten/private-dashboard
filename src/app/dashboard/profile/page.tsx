            ...
            <div className="flex gap-0 max-md:flex-wrap">
                <div className="flex flex-col grow shrink-0 self-start basis-0 w-fit max-md:max-w-full">
                    <div className="py-4 px-6 ">
                        ...
                        <p className="text-md text-neutral-400">Here, you can edit your user profile, change your avatar, and manage your workspace. Take a moment to review your settings and make any necessary updates.</p>
